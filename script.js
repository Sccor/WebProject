...
function resultat(){
    ...
    if(prenom.checkValidity() && nom.checkValidity() && email.checkValidity() && plan.checkValidity() && time.checkValidity()){
        ...
        result = result + '<div class="duo_table"><div class="modal"><li>Prix d\'un enfant par jour : 10 millions d\'euros</li><li>Prix d\'un adolescent par jour : 12 millions d\'euros</li><li>Prix d\'un adulte par jour : 15 millions d\'euros</li><li>Prix de base pour trois jour : '+prix_plan+' millions d\'euros</li></div><table class="table_result"><tr><td>Type</td><td>Nombre</td><td>Prix en millions d\'euros</td></tr><tr><td>Moins de 12ans</td><td>'+nombre_enfants+'</td><td>'+prix_enfants*nombre_enfants+'</td></tr><tr><td>12-20ans</td><td>'+nombre_ados+'</td><td>'+prix_ados*nombre_ados+'</td></tr><tr><td>Plus de 20ans</td><td>'+nombre_adultes+'</td><td>'+prix_adultes*nombre_adultes+'</td></tr><tr><td>Durée</td><td>'+time+'</td><td>'+prix_time+'</td></tr><tr><td>Total</td><td> </td><td>'+prix_total+'</td></tr></table><div class="modal"><li>Le transport n\'est pas inclus</li></div></div><div class="duo"><select name="dispo" id="dispo" required><option value="">Disponibilités</option><option value="11/08/2023 - 15/04/2024">11/08/2023 - 15/04/2024</option><option value="25/10/2027 - 05/01/2028">25/10/2027 - 05/01/2028</option><option value="30/05/2028 - 26/11/2028">30/05/2028 - 26/11/2028</option><option value="A partir du 13/03/2029">A partir du 13/03/2029</option></select></div><div class="reserve"><button type="button" id="reserve" class="form_button">Reserver</button></div>'
        console.log(result);
